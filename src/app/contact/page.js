            ...
            <div className="flex flex-col md:flex-row gap-26 ">
              ...
              <div className="md:w-1/3 flex flex-col gap-y-14">
                ...
                <div className='flex flex-col gap-y-2'>
                  ...
                  <select name="InquiryType" defaultValue="General" value={form.InquiryType} onChange={handleChange} className="w-full text-xl border-2 rounded-lg  rounded-md p-3 text-[#213359] bg-gray-100 focus:outline-none focus:ring-2 focus:ring-lime-400">
