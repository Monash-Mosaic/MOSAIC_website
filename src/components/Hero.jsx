export default function Hero() {
  return (
    <section className="text-center max-w-3xl mt-20 px-6">
      <h1 className="text-4xl md:text-6xl font-extrabold text-lime-400">AI for Social Impact</h1>
      ...
      <button className="mt-8 bg-lime-400 text-[#0C1D45] px-6 py-3 rounded-full font-semibold hover:bg-lime-300 transition">
        Explore projects
      </button>
    </section>
  );
